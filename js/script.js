...
const questions = [
    ...
    { text: "큰 모임에서 쉽게 대화를 시작한다. 🎉🗣️", type: "EI" },
    { text: "혼자 있는 시간이 필요하다고 자주 느낀다. 🧘‍♀️🌙", type: "EI" },
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!form || !questionsDiv) {
        console.error("Form or questions div not found!");
        return;
    }
